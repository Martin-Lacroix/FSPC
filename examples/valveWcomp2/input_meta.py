...
def getMetafor(input):
    ...
    app1.push(groups['SolidTop'])
    app1.push(groups['SolidBot'])
    ...
    loadingset.define(groups['ClampS'],w.Field1D(w.TX,w.RE))
    loadingset.define(groups['ClampS'],w.Field1D(w.TY,w.RE))
